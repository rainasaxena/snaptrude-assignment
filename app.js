...
scene.clearColor = new BABYLON.Color3(47 / 255, 79 / 255, 79 / 255);

// Step 1: Create a ground
const ground = BABYLON.MeshBuilder.CreateGround("ground", { width: 15, height: 35 }, scene);

// Create a Standard Material for solid color
const groundMaterial = new BABYLON.StandardMaterial("groundMaterial", scene);
groundMaterial.diffuseColor = new BABYLON.Color3(0.3, 0.8, 0.3); // Example solid green color
ground.material = groundMaterial

// ground.material = new BABYLON.("groundMaterial", scene);

ground.enableEdgesRendering();
ground.edgesWidth = 10.0;
ground.edgesColor = new BABYLON.Color4(1, 1, 1, 1);
